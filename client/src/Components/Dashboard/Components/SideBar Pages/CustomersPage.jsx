...
import '../../../Dashboard/Assets/../Components/SideBar Pages/SideBar-CSS/CustomerPage.css' // Import the CSS file
...
const fetchCustomersUsingFetchFromJS = async () => {
  const url = `${import.meta.env.VITE_API_BASE_URL}/customer`; // Ensure this is the correct endpoint
  const headers = {
